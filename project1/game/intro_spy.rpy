label intro_spy:
    ...
    menu:
        "Podróżuję ze zlecenia Gildii Kupieckiej." if pc.backg != "peasant":
            pass
        "Jestem wędrownym kupcem." if pc.backg == "peasant":
            pass
    ...
    label spy_bluff:
        ...
        n "Nie odzywając się już ani słowem więcej starzec zostawia cię samego przy stole."
